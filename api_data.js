define({ "api": [
  ...
  {
    "deprecated": {
      "content": "use {post} /:teamspace/:model/revision/:rid/groups instead"
    },
    "type": "post",
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "POST /acme/00000000-0000-0000-0000-000000000000/groups HTTP/1.1\n{\n\t\"name\":\"Group 1\",\"description\":\"\",\n\t\"author\":\"username\",\n\t\"createdAt\":\"2019-01-03T23:03:37.411Z\",\n\t\"color\":[44,50,125],\n\t\"objects\":[]\n}",
        "type": "get"
      }
    ],
    "version": "0.0.0",
    ...
    "groupTitle": "Groups",
    "groupDescription": "<p>RUOP ROUP GROUP GORUP <strong>RGPORU</strong></p>"
  },
  {
    "type": "post",
    "url": "/:teamspace/:model/revision/master/head/groups",
    "title": "Create a group",
    "name": "createGroupAtHead",
    "group": "Groups",
    "description": "<p>Add a group to the model.</p>",
    "parameter": {
      "fields": {
  ...
  {
    "type": "post",
    "url": "/:teamspace/:model/revision/:rid/groups",
    "title": "Create a group",
    "name": "createGroupAtRevision",
    "group": "Groups",
    "description": "<p>Add a group to the model.</p>",
    "parameter": {
      "fields": {
  ...
  {
    "deprecated": {
      "content": "use {delete} /:teamspace/:model/groups instead"
    },
    "type": "delete",
    "url": "/:teamspace/:model/groups/:groupId",
  ...
  {
    "type": "get",
    "url": "/:teamspace/:model/revision/master/head/groups/:uid",
    "title": "Find group by ID",
    "name": "findGroup",
    "group": "Groups",
    "description": "<p>Find group by ID.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "GET /acme/00000000-0000-0000-0000-000000000000/revision/master/head/groups/00000000-0000-0000-0000-000000000001 HTTP/1.1",
        "type": "get"
      }
    ],
    "version": "0.0.0",
  ...
  {
    "type": "get",
    "url": "/:teamspace/:model/revision/:rid/groups/:uid/",
    "title": "Find group",
  ...
  {
    "deprecated": {
      "content": "use {get} /:teamspace/:model/revision/:rid/groups/:uid instead"
    },
    "type": "get",
    "url": "/:teamspace/:model/groups/revision/:rid/:uid",
    "title": "Find group",
    "name": "findGroupByRevisionDep",
    "group": "Groups",
    "description": "<p>Find group.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "GET /acme/00000000-0000-0000-0000-000000000000/groups/revision/00000000-0000-0000-0000-000000000001/00000000-0000-0000-0000-000000000002 HTTP/1.1",
        "type": "get"
      }
    ],
    "version": "0.0.0",
  ...
  {
    "deprecated": {
      "content": "Use /:teamspace/:model/groups/revision/master/head/groups/:uid instead"
    },
    "type": "get",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "ifcguids",
            "description": "<p>Query string ifcguids returns IFC GUIDs if true where available.</p>"
          }
        ]
      }
    },
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "GET /acme/00000000-0000-0000-0000-000000000000/groups/revision/master/head/00000000-0000-0000-0000-000000000001 HTTP/1.1",
        "type": "get"
      }
    ],
    "version": "0.0.0",
  ...
  },
  {
    ...
    "group": "Groups",
    "description": "<p>List all groups associated with a model and revision.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  {
    "deprecated": {
      "content": "Use /:teamspace/:model/revision/:rid/groups/ instead"
    },
    "name": "listGroupsByRevisionDep",
    "group": "Groups",
    "description": "<p>List all groups associated with a model and revision.</p>",
    "parameter": {
      "fields": {
  ...
  {
    "deprecated": {
      "content": "use {get} /:teamspace/:model/revision/master/head/groups instead"
    },
    "type": "get",
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "GET /acme/00000000-0000-0000-0000-000000000000/groups/revision/master/head HTTP/1.1",
        "type": "put"
      }
    ],
    "version": "0.0.0",
  ...
  {
    "deprecated": {
      "content": "Use {put} /:teamspace/:model/revision/:rid/groups/:uid/ instead"
    },
    "type": "put",
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "PUT /acme/00000000-0000-0000-0000-000000000000/groups/revision/00000000-0000-0000-0000-000000000001/00000000-0000-0000-0000-000000000002 HTTP/1.1",
        "type": "get"
      }
    ],
    "version": "0.0.0",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "PAYLOAD",
            "description": "<p>The data with the comment to be added.</p>"
          }
        ]
      },
      "examples": [
  ...
  {
    "type": "get",
    "url": "/:teamspace/:model/issues/:issueId/viewpoints/:vid/screenshotSmall.png",
      ...
      "fields": {
        ...
        "Request body": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "status",
            "description": "<p>The status of the issue. It can have a value of &quot;open&quot;,&quot;in progress&quot;,&quot;for approval&quot; or &quot;closed&quot;.</p>"
          },
          {
            "group": "Request body",
            "type": "String",
            "optional": false,
            "field": "priority",
            "description": "<p>The priority of the issue. It can have a value of &quot;none&quot;, &quot;low&quot;, &quot;medium&quot; or &quot;high&quot;.</p>"
          },
          {
            "group": "Request body",
            "type": "String",
        ...
        "Request body: Viewpoint": [
          ...
          },
          {
            ...
            "description": "<p>If the issue is associated with one or more objects from the model this field has the value of a group id generated to hold those objects</p>"
          },
          {
            "group": "Request body: Viewpoint",
            "type": "Boolean",
          ...
          },
          {
            ...
            "optional": false,
            "field": "screenshot",
            "description": "<p>A string in base64 representing the screenshot associated with the issue</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "name": "updateIssue",
    "group": "Issues",
    "description": "<p>Updates an issue. It takes the part of the issue that can be updated. The system will create a system comment withing the issue describing which values were changed. The user needs to be the teamspace administrator, or the project administrator, or has the same job as the creator of the issue, or has the issue assigned. In the case that the issue has been assigned to the user, the user cant change it to the &quot;close status&quot;.</p> <p>If the issue is being updated to assigned to a job, and the status of the issue has the value &quot;for_approval&quot; then the status of the issue is automtically changed to &quot;in_progress&quot;.</p> <p>If the user is changing the issue to the &quot;for_approval&quot; status, the issue will be assigned to the job that the creator of the issue has.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
        ...
        "Request body": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "due_date",
            "description": "<p>A timestamp depicting the due date of issue.</p>"
          },
          {
            "group": "Request body",
            "type": "String",
          ...
          },
          {
            ...
            "optional": true,
            "field": "scale",
            "description": "<p>The scale of the issue.</p>"
          },
          {
            "group": "Request body",
            "type": "Number",
          ...
          },
          {
            ...
            "optional": true,
            "field": "extras",
            "description": "<p>A field containing any extras that wanted to be saved in the issue. This is normally used by BCF.</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "patch",
    "url": "/:teamspace/:model/revision/:rid/issues/:issueId",
  ...
  {
    "type": "delete",
    "url": "/:teamspace/:model/risks?ids=:ids",
    "title": "Delete risks",
    "name": "deleteRisks",
    "group": "Risks",
    "description": "<p>Delete model risks.</p>",
    "parameter": {
      "fields": {
        "Query": [
          {
            ...
            "optional": false,
            "field": "ids",
            "description": "<p>Comma separated list of IDs of risks to delete</p>"
          }
        ],
        "Parameter": [
          {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "DELETE /acme/00000000-0000-0000-0000-000000000000/risks?ids=00000000-0000-0000-0000-000000000002 HTTP/1.1",
        "type": "delete"
      }
    ],
    "success": {
  ...
  },
  {
    ...
    "title": "Create viewpoint",
    "name": "createViewpoint",
    "group": "Viewpoints",
    "description": "<p>Create a new viewpoint.</p>",
    "parameter": {
      "fields": {
        "Request body": [
          {
            ...
            "optional": false,
            "field": "name",
            "description": "<p>Name of viewpoint</p>"
          },
          {
            "group": "Request body",
            "type": "String",
  ...
  },
  {
    ...
    "group": "Viewpoints",
    "description": "<p>Delete a viewpoint.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  },
  {
    ...
    "name": "findViewpoint",
    "group": "Viewpoints",
    "description": "<p>Retrieve a viewpoint.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
      ...
      "fields": {
        "Viewpoint object": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "clippingPlanes",
            "description": "<p>Array of clipping planes</p>"
          },
          {
            "group": "Viewpoint object",
            "type": "Object",
          ...
          },
          {
            ...
            "optional": false,
            "field": "screenshot",
            "description": "<p>Screenshot object</p>"
          },
          {
            "group": "Viewpoint object",
            "type": "String",
  ...
  },
  {
    ...
    "title": "Get viewpoint thumbnail",
    "name": "getViewpointThumbnail",
    "group": "Viewpoints",
    "description": "<p>Retrieve a viewpoint's thumbnail image.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  },
  {
    ...
    "name": "listViewpoints",
    "group": "Viewpoints",
    "description": "<p>List all model viewpoints.</p>",
    "success": {
      "fields": {
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "viewpoints",
            "description": "<p>List of viewpoint objects</p>"
          }
        ],
        "Viewpoint object": [
          {
  ...
  },
  {
    ...
    "group": "Viewpoints",
    "description": "<p>Update a viewpoint.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
