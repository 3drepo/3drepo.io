...
export type IAssigneesMultiSelect = SelectProps & {
	maxItems?: number;
	showAddButton?: boolean;
	showEmptyText?: boolean;
};

export const AssigneesMultiSelect = ({
	value,
	maxItems = 3,
	showAddButton = false,
	showEmptyText = false,
	...
	const filteredValue: string[] = intersection(value, allUsersAndJobs.map((i) => i.user || i._id)) ?? [];
	...
	const overflowRequired = filteredValue.length > maxItems;
