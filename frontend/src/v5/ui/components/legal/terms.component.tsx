...
export const TermsLegalPaper = () => (
	<>
		...
		<p><ListItem>1.1.</ListItem>These terms of use (together with the other documents referred to in them,
		...
		<p><ListItem>1.2.</ListItem>The Service is provided by 3D Repo Limited (<strong>3D Repo</strong>,
		...
		<p><ListItem>1.3.</ListItem>These Terms of Use constitute a legal agreement between 3D Repo and you as
		...
		<p><ListItem>2.1.</ListItem>In order to access the Service, you must first register with 3D Repo as
		...
		<p><ListItem>2.2.</ListItem>Users may use the Service in a business capacity or in a private capacity
		...
		<p><ListItem>2.3.</ListItem>If you are acting in a business capacity, you represent to us that you are
		...
		<p><ListItem>2.4.</ListItem>To become a User, you must complete all of the required fields set out in
		...
		<p><ListItem>2.5.</ListItem>If you are subscribing to the Service as a paid User (even if we are
		...
		<p><ListItem>2.6.</ListItem>If you have been invited by a paid User of 3D Repo, you may also
		...
		<p><ListItem>2.7.</ListItem>The contract between us will only be formed (and your Subscription will
		...
		<p><ListItem>2.8.</ListItem>Your Subscription with 3D Repo will be for the period notified in the
		...
		<p><ListItem>2.9.</ListItem>The Service is intended for use worldwide, as long as it is legal for us
		...
		<p><ListItem>3.1.</ListItem>You must treat any User account log ins, User identification codes, passwords
		...
		<p><ListItem>3.2.</ListItem>You may not transfer your User account to any other person or entity. If you
		...
		<p><ListItem>3.3.</ListItem>You are responsible for the acts and omissions of any third parties who use
		...
		<p><ListItem>3.4.</ListItem>We will inform the User prior to user access being disabled. This will be
			made 24 hours before any user account changes are administered.
		</p>
		<p><ListItem>3.5.</ListItem>We will inform the User prior to any action taken on their users. Users
		...
		<p><ListItem>4.1.</ListItem><strong>The Service</strong> Associated documentation means: our
		...
		<p><ListItem>4.2.</ListItem>On condition of you agreeing to abide by these Terms of Use, we hereby grant you a
			non-transferable, non-exclusive licence while you remain a User to access the Service in accordance with
			these Terms of Use.
		</p>
		<p><ListItem>4.3.</ListItem>If your receipt of the Service is subject to third party terms, we will notify
		...
		<p><ListItem>4.4.</ListItem>If our supply of the Service is delayed, suspended or prevented by an event outside
		...
		<p><ListItem>5.1.</ListItem>The Charges payable by the User for accessing the Service
		...
		<p><ListItem>5.2.</ListItem>Unless indicated otherwise by us, the Charges are payable monthly in advance via
			our chosen payment processor using the payment card details provided by the User. 3D Repo does not store any
			payment card details.
		</p>
		<p><ListItem>5.3.</ListItem>We reserve the right to suspend the provision of the Service in the event that
			Charges are not paid when due.
		</p>
		<p><ListItem>5.4.</ListItem>Unless expressly stated otherwise, Charges are exclusive of all VAT or equivalent
			tax, which will be charged where appropriate.
		</p>
		<p><ListItem>5.5.</ListItem>We reserve the right to change the Charges at any time on written notice to you
		...
		<p><ListItem>6.1.</ListItem>As part of your use of the Service, you may submit or upload information, files,
		...
		<p><ListItem>6.2.</ListItem>Except where you have agreed otherwise, we will only use Submitted Content for the
		...
		<p><ListItem>6.3.</ListItem>We do not control, verify, or otherwise check Submitted Content and we take no
		...
		<p><ListItem>6.5.</ListItem>As part of the Service, you may share Submitted Content with Collaborators
		...
		<p><ListItem>6.6.</ListItem>You acknowledge that, if you choose to delete Submitted Content from the Service,
		...
		<Indent>
			<p><ListItem>7.1.1.</ListItem>grants to us (or, as relevant, agrees to procure the grant to us of) a
			...
			<p><ListItem>7.1.2.</ListItem>confirms that the User is duly licensed to submit the Submitted Content to
			...
			<p><ListItem>7.1.3.</ListItem>agrees that we may run data analytics on the Submitted Content for the
			...
			<p><ListItem>7.1.4.</ListItem>agrees that Submitted Content may become part of a database and that we will
				own the rights in that database.
			</p>
		</Indent>
		<p><ListItem>7.2.</ListItem>Except for Submitted Content, we are the owner or the licensee of all IP Rights
		...
		<p><ListItem>7.3.</ListItem>You are under no obligation to provide feedback, improvements, or other
		...
		<p><ListItem>8.1.</ListItem>We do not guarantee that the Service will always be available or that
		...
		<p><ListItem>8.2.</ListItem>In relation to the use of the Service:</p>
		<Indent>
			<p><ListItem>8.2.1.</ListItem>to the extent permitted by law, we exclude all conditions, warranties,
				representations, or other terms which may apply to the Service, whether express or implied.
			</p>
			<p><ListItem>8.2.2.</ListItem>we will have no responsibility or liability to any party other than
				the User; and
			</p>
			<p><ListItem>8.2.3.</ListItem>We use reasonable endeavours to remove bugs, viruses, or other malware
		...
		<p><ListItem>8.3.</ListItem>We use reasonable endeavours to remove bugs, viruses, or other malware but we do
		...
		<p><ListItem>8.4.</ListItem>Subject to clauses 9.1 to 9.4, our total liability, whether in contract, tort
		...
		<p><ListItem>8.5.</ListItem>You agree to indemnify us in respect of all loss or damage whatsoever arising from
			your breach of these Terms of Use.
		</p>
		<ol start={9}>
			<li><h2>Prohibited uses of the Service</h2></li>
		</ol>
		<p><ListItem>9.1.</ListItem>You may use the Service only for lawful purposes. You may not use the Service:</p>
		<Indent>
			<p><ListItem>9.1.1.</ListItem>in any way that breaches any applicable local, national, or international
				law or regulation; or
			</p>
			<p><ListItem>9.1.2.</ListItem>in any way that is unlawful or fraudulent or has any unlawful or fraudulent
				purpose or effect.
			</p>
		</Indent>
		<p><ListItem>9.2.</ListItem>You agree:</p>
		<Indent>
			<p><ListItem>9.2.1.</ListItem>not to (and not to attempt to) modify, copy, disclose, distribute, or
			...
			<p><ListItem>9.2.2.</ListItem>not to impersonate any other Users; and</p>
			<p><ListItem>9.2.3.</ListItem>not to access without authority, penetrate, interfere with, damage, or disrupt
		...
		<p><ListItem>9.3.</ListItem>You also agree to comply with the content standards set out in clause 9.4 below,
		...
		<p><ListItem>9.4.</ListItem>Your use of the Service (including all Submitted Content) must not:</p>
		<Indent>
			<p><ListItem>9.4.1.</ListItem>contain any material which is defamatory or inaccurate of any person.</p>
			<p><ListItem>9.4.2.</ListItem>contain any material which is obscene, offensive, hateful, or
				inflammatory or otherwise be likely to harass, upset, embarrass, alarm, or annoy any other person.
			</p>
			<p><ListItem>9.4.3.</ListItem>promote indecent or sexually explicit material or violence.</p>
			<p><ListItem>9.4.4.</ListItem>promote discrimination based on race, sex, religion, nationality,
				disability, sexual orientation, or age.
			</p>
			<p><ListItem>9.4.5.</ListItem>infringe any copyright, database right, trademark, or other intellectual
				property rights of any other person.
			</p>
			<p><ListItem>9.4.6.</ListItem>contain photographs, images, or other representations of another person
				without his or her permission (or in the case of a minor, the minor&apos;s legal guardian).
			</p>
			<p><ListItem>9.4.7.</ListItem>impersonate any person or to misrepresent your identity or affiliation
				with any person or otherwise be likely to deceive or mislead any person.
			</p>
			<p><ListItem>9.4.8.</ListItem>be in breach of any legal duty owed to a third party, such as a
				contractual duty or a duty of confidence.
			</p>
			<p><ListItem>9.4.9.</ListItem>advocate, promote, assist, or enable any illegal or unlawful activities
			...
			<p><ListItem>9.4.10.</ListItem>give the impression that it emanates from us, if this is not the case; or</p>
			<p><ListItem>9.4.11.</ListItem>disseminate or otherwise disclose another person&apos;s personal
		...
		<p><ListItem>10.1.</ListItem><strong>Consumer cancellation right:</strong> If you are registered to use the
		...
		<p><ListItem>10.2.</ListItem>All Users may end their Subscription (or other access as a User) at any time by
		...
		<p><ListItem>10.3.</ListItem>Should there be any malicious or other activity in breach of these Terms of Use,
		...
		<p><ListItem>10.4.</ListItem>The User acknowledges that, we will preserve your Submitted Content for a month
		...
		<p><ListItem>11.1.</ListItem>You will be asked to read and accept these Terms of Use at the time you first
			access the Service.
		</p>
		<p><ListItem>11.2.</ListItem>We may update the Service from time to time and may change the content and/or
		...
		<p><ListItem>11.3.</ListItem>No variation to these Terms of Use may be made save by a variation notified by
			us as described above, or else in writing signed by you and/or the User and us.
		</p>
		<ol start={12}>
			<li><h2>Trademarks</h2></li>
		</ol>
		<p><ListItem>12.1.</ListItem>&quot;3D Repo&quot;, &quot;3D Diff&quot;, &quot;3D Send&quot;,
