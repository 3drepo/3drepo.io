		...
		<DashboardScroll>
			<Content>
				<Switch>
					...
					<Route title={formatMessage({ id: 'pageTitle.issuesAndRisks', defaultMessage: ':project - Issues & Risks' })} exact path={`${path}/t/board`}>
						<Redirect to={`${discardSlash(pathname)}/issues`} />
					</Route>
					<Route title={formatMessage({ id: 'pageTitle.issuesAndRisks', defaultMessage: ':project - Issues & Risks' })} exact path={`${path}/t/board/:type?/:containerOrFederation?`}>
						<Board />
					</Route>
