...
import { drawingRevisionsReducer } from '@/v5/store/drawingRevisions/drawingRevisions.redux';
...
import { containerRevisionsReducer } from '@/v5/store/containerRevisions/containerRevisions.redux';
