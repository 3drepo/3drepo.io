...
export type SetVector2DAction = Action<'SET_VECTOR2D_ACTION'> & { vector2D: Vector2D };
export type SetVector3DAction = Action<'SET_VECTOR3D_ACTION'> & { vector3D: Vector3D };
export type SetIsCalibrating3dAction = Action<'SET_IS_CALIBRATING3D_ACTION'> & { isCalibrating3d: boolean };
