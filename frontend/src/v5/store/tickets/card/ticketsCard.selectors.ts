...
export const selectTicketPins = createSelector(
	...
	selectSelectedDate,
	selectShowPins,
	(tickets, templates, view, selectedTicketPinId, selectedTicket, selectedSequenceDate, showPins): IPin[] => {
		if (!showPins || view === TicketsCardViews.New || !tickets.length) return [];
