...
import * as ContainerRevisionsSelectors from '@/v5/store/containers/containerRevisions/containerRevisions.selectors';
...
import * as DrawingRevisionsSelectors from '@/v5/store/drawings/drawingRevisions/drawingRevisions.selectors';
