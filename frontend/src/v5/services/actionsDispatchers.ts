...
import { ViewerActions, ViewerActionCreators } from '@/v5/store/viewer/viewer.redux';
...
export const ViewerActionsDispatchers = createActionsDispatchers<ViewerActionCreators>(ViewerActions);
