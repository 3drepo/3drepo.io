...
import containerRevisionsSaga from '@/v5/store/containers/containerRevisions/containerRevisions.sagas';
...
import drawingRevisionsSaga from '@/v5/store/drawings/drawingRevisions/drawingRevisions.sagas';
