...
export const { Types: UserManagementTypes, Creators: UserManagementActions } = createActions({
	...
	updatePermissions: ['permissions', 'permissionsType', 'permissionsCount'],
	...
	updateProjectPermissions: ['permissions', 'permissionsType', 'permissionsCount'],
	...
	updateModelsPermissions: ['modelsWithPermissions', 'permissionsType', 'permissionsCount'],
	updateModelsPermissionsPre: ['modelsWithPermissions', 'permissionsType', 'permissionsCount'],
