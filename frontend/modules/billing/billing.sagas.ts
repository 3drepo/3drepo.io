...
export function* fetchPlans() {
	try {
		...
		yield put(DialogActions.showErrorDialog('fetch', 'plans', e));
	}
}
...
export function* fetchSubscriptions({ teamspace }) {
	try {
		...
		yield put(
			DialogActions.showErrorDialog('fetch', 'subscriptions', e)
		);
	}
}
...
export function* fetchInvoices({ teamspace }) {
	try {
		...
		yield put(DialogActions.showErrorDialog('fetch', 'invoices', e));
	}
}
...
export function* changeSubscription({ teamspace, subscriptionData }) {
	try {
		...
		yield put(
			DialogActions.showErrorDialog('post', 'subscription', e)
		);
	}
}
...
export function* downloadInvoice({ teamspace, invoiceNo }) {
	try {
		...
		yield put(DialogActions.showErrorDialog('download', 'invoice', e));
	}
}
