...
export function* fetchJobs({ teamspace }) {
	try {
		...
		yield put(DialogActions.showErrorDialog('get', 'jobs', error));
	}
}
...
export function* fetchJobsColors({ teamspace }) {
	try {
		...
		yield put(DialogActions.showErrorDialog('get', 'jobs colors', error));
	}
}
...
export function* updateJobColor({ job }) {
	try {
		...
		yield put(DialogActions.showErrorDialog('update', 'job color', error));
	}
}
...
export function* createJob({ job }) {
	try {
		...
		yield put(DialogActions.showErrorDialog('create', 'job', error));
	}
}
...
export function* removeJob({ jobId }) {
	try {
		...
		yield put(DialogActions.showErrorDialog('remove', 'job', error));
	}
}
