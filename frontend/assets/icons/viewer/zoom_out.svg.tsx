...
export default ({ className }: IProps) => (
	<svg width="18" height="18" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
		...
		<path
			className="highlight"
			d="M6.67798 9.80542C6.67798 9.39768 7.00852 9.06714 7.41626 9.06714H12.1946C12.6023 9.06714 12.9329 9.39768 12.9329 9.80542C12.9329 10.2132 12.6023 10.5437 12.1946 10.5437H7.41626C7.00852 10.5437 6.67798 10.2132 6.67798 9.80542Z"
			fill="currentColor"
		/>
	</svg>
);
