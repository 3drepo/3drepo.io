...
export default ({ className, style, iconRef, onMouseDown, haloVisibility }: IProps) => (
	<svg width="100" height="100" viewBox="0 0 100 100" onMouseDown={onMouseDown} ref={iconRef} fill="none" version="1.1"
		...
		<g filter="url(#filter0_d_11_9573)" id="g8" transform="rotate(45,72.286839,-4.9870769)">
			<circle fill="#009baa" cx="24.700001" cy="50.021999" r="9" transform="rotate(42.6921,24.7,50.022) " id="circle4" />
		...
		<defs id="defs36">
			...
			<radialGradient id="paint0_radial_11_9573" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse"
				...
				<stop stopColor="#00C1D4" stopOpacity="0.6" id="stop31" />
				<stop stopColor="#00C1D4" offset="1" stopOpacity="0" id="stop33" />
			</radialGradient>
		...
		<path id="path5518" stroke="#00c1d4" strokeWidth="1.1063" strokeDasharray="11.063, 5.53153" opacity={1 - haloVisibility}
