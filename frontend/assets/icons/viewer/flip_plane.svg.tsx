...
export default ({ className }: IProps) => (<svg width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
	<g id="flip-plane-o">
		<path className="primary" fillRule="evenodd" clipRule="evenodd" d="M1.31641 3.07617C1.31641 2.02769 2.16637 1.17773 3.21484 1.17773H8.41797V16.7344H3.21484C2.16637 16.7344 1.31641 15.8844 1.31641 14.8359V3.07617Z" fill="currentColor"/>
