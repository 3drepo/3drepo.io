...
export default () =>
	(
		<svg width="110" height="96" viewBox="0 0 110 96" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<path d="M58.1473 37.7273H51.8384L52.3369 65.7053H57.6487L58.1473 37.7273ZM54.9832 77.3644C57.0734 77.3644 58.8185 75.6577 58.8185 73.5291C58.8185 71.4389 57.0734 69.7131 54.9832 69.7131C52.8739 69.7131 51.148 71.4389 51.148 73.5291C51.148 75.6577 52.8739 77.3644 54.9832 77.3644Z" fill="#F5CB34" />
		</svg>
	);
