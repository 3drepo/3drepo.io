...
export const CRITERIA_TEMPLATES = {
	[CRITERIA_OPERATORS_TYPES.IS]: '%field% : %0',
	[CRITERIA_OPERATORS_TYPES.IS_NOT]: '%field% : ! %0',
	[CRITERIA_OPERATORS_TYPES.IS_NOT_EMPTY]: '%field%',
	[CRITERIA_OPERATORS_TYPES.IS_EMPTY]: '! %field%',
	[CRITERIA_OPERATORS_TYPES.CONTAINS]: '%field% : * %0',
	[CRITERIA_OPERATORS_TYPES.NOT_CONTAINS]: '%field% : ! * %0',
	[CRITERIA_OPERATORS_TYPES.EQUALS]: '%field% = %0',
	[CRITERIA_OPERATORS_TYPES.NOT_EQUALS]: '%field% = ! %0',
