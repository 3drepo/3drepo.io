...
module.exports = {
	...
	// regardless of lingering open handles (e.g. MongoDB client sockets not
	// fully awaited on close, like in Handler.authenticate). Without an
	// equivalent, jest just hangs waiting for the event loop to drain.
	forceExit: true,
	maxWorkers: 1,
