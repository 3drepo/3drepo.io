...
describe("Billing agreement price from PayPal", function () {
	...
	let server;
	let agent;
	const username = "price_testing";
	const password = "price_testing";
	const email = "price_testing@mailinator.com";
	...
	describe("increase 1 licence", function() {
		...
		before(function() {
			...
			const twoDaysAgo = moment.utc().subtract(2, "Day").startOf("date");
			const nextPaymentDate = getNextPaymentDate(twoDaysAgo);
