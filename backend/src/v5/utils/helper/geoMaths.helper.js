...
class Vector3DBinaryToStringStream extends Transform {
	constructor(opts = {}) {
		super(opts);
		this.started = false;
...
class FaceBinaryToStringStream extends Transform {
	constructor(opts = {}) {
		super(opts);
		this.started = false;
...
const GeoMathsHelper = {
	Vector3DBinaryToStringStream,
	FaceBinaryToStringStream,
};

module.exports = GeoMathsHelper;
