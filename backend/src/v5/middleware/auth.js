...
const { CSRF_COOKIE, SESSION_HEADER } = require('../utils/sessions.constants');
...
const ipAddressMatched = async (req, res, next) => {
...
AuthMiddleware.validSession = validateMany([validSession, ipAddressMatched]);
