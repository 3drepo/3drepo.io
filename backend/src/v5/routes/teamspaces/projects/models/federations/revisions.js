...
const establishRoutes = () => {
	...
	/**
     * @openapi
     * /teamspaces/{teamspace}/projects/{project}/federations/{federation}/revisions/files/original/info:
     *   get:
     ...
     *                     size: 123456780
     */
	router.get('/files/original/info', hasReadAccessToFederation, getFederationMD5Hash, serialiseRevisionArray);
