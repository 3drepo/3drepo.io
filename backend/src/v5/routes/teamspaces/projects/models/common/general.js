...
>>>>>>> 5345bdd2aa31772b701346ebfcf59c6562068ff8
		 ...
		 *   delete:
		 *     description: Delete container from project
		 ...
		 *         description: Model removed.
		 */
		router.delete('/:model', hasAdminAccessToContainer, canDeleteContainer, deleteModel(modelType));
		 ...
		 *         description: updates the settings of the model
		 */
		router.patch('/:model', hasAdminAccessToContainer, validateUpdateSettingsData(modelType), updateModelSettings(modelType));
		...
		/**
		 * @openapi
		 * /teamspaces/{teamspace}/projects/{project}/containers/{model}/stats:
		 *   get:
		 *     description: Get the statistics and general information about a model
		 *     tags: [v:internal, Models]
		 *     operationId: getModelStats
