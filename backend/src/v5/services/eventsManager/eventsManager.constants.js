...
const eventList = [
	...
	'TICKETS_IMPORTED', 'TICKET_TEMPLATE_UPDATED',
	// Revisions
	'REVISION_UPDATED',
	// Queue specific
	'QUEUED_TASK_UPDATE', 'QUEUED_TASK_COMPLETED',
	// Clash related
	'CLASH_RUN_COMPLETED', 'CLASH_RUN_UPDATE', 'CLASH_RUN_RESULTS_PROCESSED', 'CLASH_PLAN_UPDATED', 'CLASH_RUN_STATUS_UPDATED',
	// Socket IO events
	'CHAT_EVENT',
	// Authentication
	'FAILED_LOGIN_ATTEMPT', 'SUCCESSFUL_LOGIN_ATTEMPT', 'SESSION_CREATED', 'SESSIONS_REMOVED',
	// User related
	'USER_CREATED',
