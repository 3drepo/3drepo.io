...
const testViewList = () => {
	const createRoute = (projectId = project.id, modelId = modelWithViews._id) =>
		`/v5/teamspaces/${teamspace}/projects/${projectId}/containers/${modelId}/views`;
	describe('Views List', () => {
...
const testViewThumbnail = () => {
	const createRoute = (projectId = project.id, modelId = modelWithViews._id, viewId = viewWithThumbnail._id) =>
		`/v5/teamspaces/${teamspace}/projects/${projectId}/containers/${modelId}/views/${viewId}/thumbnail`;
