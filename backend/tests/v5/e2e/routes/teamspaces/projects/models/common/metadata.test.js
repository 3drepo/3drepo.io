	...
	describe('Get asset maps', () => {
		...
		const generateTestData = () => {
			...
			const contVoidRevs = [
				...
				['trying to get latest form container with newer void revision via without supplying a revision', getContRoute({ modelId: C3Id, revisionId: null }), true, validRevResultC3],
				['trying to get latest form container with newer void revision without supplying a revision', getContRoute({ modelId: C3Id, revisionId: null, key: viewerKey }), true, validRevResultC3],
				['trying to get latest form container with newer void revision without supplying a revision', getContRoute({ modelId: C3Id, revisionId: null, key: commenterKey }), true, validRevResultC3],
			];
			...
			const contNoFileRevisions = [
				...
				['Try to access noFile revision without supplying a revision (admin)', getContRoute({ modelId: C4Id, revisionId: null }), true, noFileRevResult],
				['Try to access noFile revision without supplying a revision (viewer)', getContRoute({ modelId: C4Id, revisionId: null, key: viewerKey }), true, noFileRevResult],
				['Try to access noFile revision without supplying a revision (commenter)', getContRoute({ modelId: C4Id, revisionId: null, key: commenterKey }), true, noFileRevResult],
			];
