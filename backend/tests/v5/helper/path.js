...
PathHelper.objModelDwg = Path.join(PathHelper.modelFolder, 'dummy.dwg');
...
PathHelper.objModelUppercaseExtDwg = Path.join(PathHelper.modelFolder, 'dummyUppercaseExt.DWG');
