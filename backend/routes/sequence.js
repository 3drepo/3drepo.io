 ...
 * @apiName getSequenceActivityDetailOld
 * @apiGroup Sequences
 * @apiDescription Get sequence activity details.
 * @apiDeprecated use now (#Sequences:getSequenceActivityDetail)
 *
 * @apiUse Sequences
 *
 ...
 * @apiName getSequenceActivitiesOld
 * @apiGroup Sequences
 * @apiDescription Get all sequence activities.
 * @apiDeprecated use now (#Sequences:getSequenceActivities)
 *
 * @apiUse Sequences
 *
 ...
 * @apiName getSequenceStateOld
 * @apiGroup Sequences
 * @apiDescription Get state of model in sequence.
 * @apiDeprecated use now (#Sequences:getSequenceState)
 *
 * @apiUse Sequences
 *
 * @apiParam {String} sequenceId Sequence unique ID
 ...
 * @apiName updateLegendOld
 * @apiGroup Sequences
 * @apiDescription Update/add a legend to this sequence
 * @apiDeprecated use now (#Sequences:updateLegend)
 *
 * @apiUse Sequences
 *
 ...
 * @apiName getLegendOld
 * @apiGroup Sequences
 * @apiDescription Get the legend for this sequence
 * @apiDeprecated use now (#Sequences:getLegend)
 *
 * @apiUse Sequences
 *
 * @apiExample {get} Example usage (/master/head)
 ...
 * @apiName deleteLegendOld
 * @apiGroup Sequences
 * @apiDescription Delete the legend associated to this sequence
 * @apiDeprecated use now (#Sequences:deleteLegend)
 *
 * @apiUse Sequences
 *
 ...
 * @apiName listSequencesOld
 * @apiGroup Sequences
 * @apiDescription List all sequences associated with the model.
 * @apiDeprecated use now (#Sequences:listSequences)
 *
 * @apiUse Sequences
 *
 * @apiExample {get} Example usage (/master/head)
