...
(function(){
	...
	function i(e,t){
		...
		if(!(this instanceof s)){
			return new s(e,t);
		}"string"===typeof e&&(e=document.querySelectorAll(e)),this.elements=o(e),this.options=i({},this.options),"function"===typeof t?n=t:i(this.options,t),n&&this.on("always",n),this.getImages(),a&&(this.jqDeferred=new a.Deferred);let r=this;setTimeout(function(){
			r.check();
		});
	}function f(e){
		this.img=e;
		...
		this.images=[];for(let e=0,t=this.elements.length;t>e;e++){
			let n=this.elements[e];"IMG"===n.nodeName&&this.addImage(n);let i=n.nodeType;if(i&&(1===i||9===i||11===i)){
				for(let r=n.querySelectorAll("img"),o=0,s=r.length;s>o;o++){
					let f=r[o];this.addImage(f);
				}
			}
		}
	},s.prototype.addImage=function(e){
		let t=new f(e);this.images.push(t);
		...
		let n=new s(this,e,t);return n.jqDeferred.promise(a(this));
	}),f.prototype=new t,f.prototype.check=function(){
		let e=v[this.img.src]||new c(this.img.src);if(e.isConfirmed){
