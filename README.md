...
## Running on WSL2
Some prerequisites to ensure 3drepo works when running in WSL2 in conjunction with local repo.
...
To pick up correct config or whichever env you are using.
```bash
export NODE_ENV=development 
```

Create teamspace (3drepo.io repo):
```bash
